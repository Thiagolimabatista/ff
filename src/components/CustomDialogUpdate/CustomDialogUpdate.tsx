...
const CustomDialogUpdate: React.FC<CustomDialogProps> = ({ open, onClose }) => (
  <DialogAnimate open={open} onClose={onClose}>
    ...
    >
      ...
      <Typography variant="h5">Bloqueio editado com sucesso!</Typography>
...
export default CustomDialogUpdate;
